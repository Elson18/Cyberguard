...
const FALLBACK_TRANSLATIONS = {
  nav_dashboard: 'Home',
  nav_extension: 'Browser Protection',
  nav_extension_short: 'Browser Protection',
  nav_email_verification: 'Check Email',
  nav_complaint: 'Report Problem',
  nav_settings: 'Settings',
  sidebar_status: 'Protected ✓',
  sidebar_new_session: '＋ New Chat',
  sidebar_system_status: 'System Status',
  btn_exit: 'Exit',
  chat_title: 'How can we help?',
  chat_subtitle: '',
  chat_extension_btn: 'Protect Browser',
  chat_ai_tag: 'Online',
  chat_empty: 'Tell us what happened 👇',
  chat_placeholder: 'Type here or ask anything…',
  chat_complaint_btn: '📝 Report This',
  chat_success: '✅ Your report has been sent. Our team will contact you shortly.',
  settings_title: 'Settings',
  settings_subtitle: 'Manage your settings.',
};
